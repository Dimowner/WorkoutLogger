 ...
 * @author Dimowner
 */
public class AllExercisesFragment extends Fragment implements IAllExercisesView {
...
//	private MyAdapter mAdapter;
	...
	public void onCreate(@Nullable Bundle savedInstanceState) {
		...
		WLApplication.get(getContext()).applicationComponent().plus(new ExercisesModule()).inject(this);
	}
...
//				startActivity(intent);
		...
		mAdapter.setOnFavoriteClickListener(new OnFavoriteClickListener() {
			...
			public void onFavoriteClick(View view, int position, int id, int action) {
				if (action == ExpandableListAdapter.ACTION_ADD_TO_FAVORITES) {
	...
	@Override
	public void showAllExercises(List<ExerciseModel> list) {
...
//		mAdapter.notifyDataSetChanged();
	...
	public class ExpandableListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
		...
		public ExpandableListAdapter(List<ListItem> myDataset) {
...
//						Glide.with(mContext)
//								.load(R.drawable.fitness2).fitCenter().into(groupViewHolder.ivImage);
//					} else if (position % 5 == 2) {
//						Glide.with(mContext)
//								.load(R.drawable.fitness3).fitCenter().into(groupViewHolder.ivImage);
//					} else if (position % 5 == 3) {
//						Glide.with(mContext)
//								.load(R.drawable.fitness4).fitCenter().into(groupViewHolder.ivImage);
//					} else if (position % 5 == 4) {
//						Glide.with(mContext)
//								.load(R.drawable.fitness5).fitCenter().into(groupViewHolder.ivImage);
//					}
					break;
				case TYPE_CHILD:
					...
					childViewHolder.ivIcon.setOnClickListener(new View.OnClickListener() {
						...
						public void onClick(View v) {
							if (onFavoriteClickListener != null) {
								...
								onFavoriteClickListener.onFavoriteClick(v, posChild, mShowingData.get(posChild).getId(), action);
								if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP){
...
//					} else if (position % 5 == 1) {
//						Glide.with(mContext)
//								.load(R.drawable.fitness2).fitCenter().into(childViewHolder.ivImage);
//					} else if (position % 5 == 2) {
//						Glide.with(mContext)
//								.load(R.drawable.fitness3).fitCenter().into(childViewHolder.ivImage);
//					} else if (position % 5 == 3) {
//						Glide.with(mContext)
//								.load(R.drawable.fitness4).fitCenter().into(childViewHolder.ivImage);
//					} else if (position % 5 == 4) {
//						Glide.with(mContext)
//								.load(R.drawable.fitness5).fitCenter().into(childViewHolder.ivImage);
//					}
					break;
			}
		}
